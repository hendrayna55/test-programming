                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div class="form-group row text-sm">
                                                ...
                                                <div class="input-group col-12 col-sm-12 col-lg-7">
                                                    <input type="text" class="form-control form-control-sm @error('kode_transaksi') is-invalid @enderror" id="kode_transaksi" value="{{date('Ym', strtotime($now)) . '-' . $nomor_transaksi}}" name="kode_transaksi" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row text-sm">
                                                ...
                                                <div class="input-group col-12 col-sm-12 col-lg-7">
                                                    <input type="datetime-local" class="form-control form-control-sm @error('tanggal_transaksi') is-invalid @enderror" id="tanggal_transaksi" value="{{old('tanggal_transaksi')}}" name="tanggal_transaksi" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-6 mb-4">
                                                ...
                                                <div class="input-group col-12 col-sm-12 col-lg-8">
                                                    <select name="kode_customer" id="kode_customer" class="form-control form-control-sm @error('kode_customer') is-invalid @enderror" required>
                                                        ...
                                                        @foreach ($customers as $item)
                                                            <option value="{{$item->id}}" data-name="{{$item->name}}" data-telp="{{$item->telp}}" {{old('kode_customer') ? 'selected' : ''}}>{{$item->kode}} - {{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row text-sm">
                                                ...
                                                <div class="input-group col-12 col-sm-12 col-lg-8">
                                                    <input type="text" class="form-control form-control-sm @error('nama_customer') is-invalid @enderror" id="nama_customer" value="" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row text-sm">
                                                ...
                                                <div class="input-group col-12 col-sm-12 col-lg-8">
                                                    <input type="text" class="form-control form-control-sm @error('telp_customer') is-invalid @enderror" id="telp_customer" value="" readonly>
                                                </div>
                                            </div>
                                        </div>
